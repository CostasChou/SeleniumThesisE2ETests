...
public class TC01_LogInCorrectUsernameCorrectPasswordOK {
	...
	//Runs before test. Works as a SetUp for the test to be executed.Prerequisuites could be performed here
	@BeforeTest
	@Parameters({"browser"})
	public void setUpTest(String browser) {
		...
		// Start reporters.
		htmlReporter = new ExtentHtmlReporter(projectPath + "/TestsReports/TC01_LogInCorrectUsernameCorrectPasswordOK.html");
	...
	public static void tC01LogInCorrectUsernameCorrectPasswordOK(String username, String password) throws Exception {
		...
		ExtentTest test = extent.createTest("TC01: User is logged in successfully when correct credentials are entered");
